...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.registration = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, role, finduser, hash, user, token;
    ...
    UserController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, fullname, DateofBirth, mail, licensenumber, updateUser, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        id = req.query.id;
                        _a = req.body, fullname = _a.fullname, DateofBirth = _a.DateofBirth, mail = _a.mail, licensenumber = _a.licensenumber;
